        ...
        <div class="container-fluid">
          ...
          <div class="az-header-right">
            <div class="dropdown az-profile-menu">
              <a href="" class="az-img-user"><img src="upload/<?php echo $_SESSION['uts_wakeel_main_secret_pic']; ?>" alt=""></a>
              <div class="dropdown-menu">
                ...
                <div class="az-header-profile">
                  <div class="az-img-user">
                    <img src="upload/<?php echo $_SESSION['uts_wakeel_main_secret_pic']; ?>" alt="">
                  </div><!-- az-img-user -->
