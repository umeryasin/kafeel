...
<html lang="en">
  <head>
    ...
    <title>View Company / Sponsers - Kafeel</title>
          ...
          <table class="table table-hover table-bordered table-striped">
            <thead>
              <tr>
                ...
                <th>Mobile 2</th>
                <th>Nationality</th>
                <th>Client / Sub Admin</th>
                <th>Action</th>
              </tr>
            </thead>
            <tbody>
              <?php
              $sql_all="SELECT * FROM `wakeel_info`";
              ...
              while($row_all=mysqli_fetch_assoc($result_all))
              {
                ...
                <tr>
                  ...
                  <td>
                    <?php
                    $sql_client="SELECT * FROM `admin_info` WHERE `admin_id`=".$row_all['wi_sub_admin_id'];
                    //echo $sql_client;
                    $result_client=mysqli_query($ob->makeconn(),$sql_client);
                    $row_client=mysqli_fetch_assoc($result_client);
                    echo $row_client['admin_name'];
                    ?>
                  </td>
                  <td>
  ...
  <div id="modaldemo1" class="modal">
    ...
    <script type="text/javascript">
      $("#adv-company-sps-main").addClass("active");
      $("#adv-company-sps-main").addClass("show");
      $("#add-view-company-sponsers").addClass("active");
    </script>
    <script type="text/javascript">
      $(".view-btn").on("click",function(){
        var view_id=$(this).val();
         window.open('view-single-company.php?wid='+view_id,'_blank');
      });
    </script>
    <script type="text/javascript">
