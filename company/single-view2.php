...
<html lang="en">
	...
	<div class="container bootstrap snippet">
	    <div class="row">
	  		<div class="col-sm-10"><h1>Advocate Info</h1></div>
    ...
    <div class="row">
	      ...
	      <div class="text-center">
	        <img src="upload/<?php echo $row_all['ci_profile_pic']; ?>" class="avatar img-circle img-thumbnail" alt="avatar" style="max-width: 183px;">
	      </div></hr><br>
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <?php echo $row_all['ci_desigination']; ?>
            </div>
          </div>
          ...
          <form class="form" action="##" method="post" id="registrationForm">
            ...
            <div class="panel panel-default">
              ...
              <div class="col-xs-6">
                ...
                <div class="col-xs-6">
                  <div class="form-group">
                        <img src="upload/<?php echo $row_all['ci_emirates_id_image']; ?>" width="200">
                    </div>
                </div>
                <div class="col-xs-6">
                  <div class="form-group">
            ...
            <div class="panel panel-default">
              ...
              <div class="col-xs-6">
                ...
                <div class="col-xs-6">
                  <div class="form-group">
                        <img src="upload/<?php echo $row_all['ci_passport_image']; ?>" width="200">
                    </div>
                </div>
                <div class="col-xs-6">
                  <div class="form-group">
              ...
              <div class="col-xs-6">
                  <div class="form-group">
                    <h4>Labor Contract Image</h4>
                        <img src="upload/<?php echo $row_all['ci_labor_contract_image']; ?>" width="200">
                    </div>
                </div>
            </div>
             </div>
