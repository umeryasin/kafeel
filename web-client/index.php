...
<html lang="en">
  <head>
    ...
    <title>Client Dashboard - Kafeel</title>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-success card-header-icon">
                  ...
                  <h2 class="card-category">Companies</h2>
                  <h3 class="card-title">
                    <a href="view-advocate-active.php">
                    <?php
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-warning card-header-icon">
                  <div class="card-icon">
                    <i class="fas fa-check fa-6x" style="color:#28a745!important;"></i>
                  </div>
                  <h2 class="card-category">Active Status</h2>
                  <h3 class="card-title">
                  <a href="view-advocate-active.php?status=act">
                    <?php
                    $sql_adv_act="SELECT COUNT(*) AS total FROM `wakeel_info` WHERE `wi_act_status`=1 AND `wi_del_status`=0 AND `wi_sub_admin_id`=$admin_id";
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-info card-header-icon">
                  <div class="card-icon">
                    <i class="fas fa-times fa-6x" style="color:#dc3545!important;"></i>
                  </div>
                  <h2 class="card-category">Deactive Status</h2>
                  <h3 class="card-title">
                    <a href="view-advocate-active.php?status=deact">
                      <?php
                      $sql_adv_de="SELECT COUNT(*) AS total FROM `wakeel_info` WHERE `wi_act_status`=0 AND `wi_del_status`=0 AND `wi_sub_admin_id`=$admin_id";
                      $result_adv_de=mysqli_query($ob->makeconn(),$sql_adv_de);
                      $row_adv_de=mysqli_fetch_assoc($result_adv_de);
                      echo $row_adv_de['total'];
                      ?>
                    </a>
                  </h3>
                </div>
